const hoadon = (function (){
    ...
    return {
        ...
        delete: function ( id ) { // XÓA HÓA ĐƠN RA KHỎI GIỎ
            ...
            for (const iterator of this.get()) {
                if ( iterator.status == status ) {
                    ...
                    khungchua.innerHTML += `<table class="table">
                                                <tr>
                                                    <td class="title">Đang giao hàng <b>${iterator.id}</b></td><td>Đặt lúc: </td><td class="bold" colspan="3">${iterator.date}</td>
                                                </tr>
                                                <tr>
                                                    <td  class="title">Tên : </td><td colspan="2" class="bold">${iterator.name}</td><td>SĐT: </td><td class="bold">${iterator.phone}</td>
                                                </tr>
                                                <tr>
                                                    <td  class="title">Email :</td><td class="bold" colspan="4"> ${iterator.email}</td>
                                                </tr>
                                                <tr>
                    ...
                    khungchua.innerHTML += `<table class="margin">
                                                ...
                                                <tr>
                                                    <td class="btncancel"><button class="cancel form-control" value="${iterator.id}" name="${iterator.email}" alt="">Hủy đơn hàng</button></td><td></td><td></td>
                                                </tr>
                                            </table>`;
                }
            }
