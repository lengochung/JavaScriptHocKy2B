...
class CustomerTM {
    constructor ( form ) {
        ...
        this.email = form['email'].value + form['email_end'].value;
        this.adress = checkform.toUpper(form['adress3'].value) + ', ' + form['adress7'].value + ', ' + form['adress2'].value + ', ' + form['adress1'].value;
    }
} 
class CustomerCK {
    constructor ( form ) {
        this.name = get.id('name_ck_tm').innerText;
        this.phone = form['phoneck'].value;
        this.email = form['email_ck'].value + form['email_end_ck'].value;
        this.adress = form['adress6'].value + ', ' + form['adress8'].value + ', ' + form['adress5'].value + ', ' + form['adress4'].value;
    }
}
// Lớp Hóa Đơn
class HoaDon {
    constructor ( check ) {
        if ( check == 1){
            ...
            this.email = JSON.parse(localStorage.tm).email;
            ...
            this.email = get.id('email_ck').value + get.id('email_end_ck').value;
